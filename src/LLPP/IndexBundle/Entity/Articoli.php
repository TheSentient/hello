...
class Articoli {
  ...
  private $categorie;
   ...
   // ...
    /**
     * @ORM\OneToMany(targetEntity="CommentiArticoli", mappedBy="articoli")
     **/
    private $commenti;
    // ...
     ...
     * @return Articoli
     */
    public function addCategorie(\LLPP\IndexBundle\Entity\CategorieArticoli $categorie)
    {
     ...
     * @param \Grafill\ManagerBundle\Entity\CategorieArticoli $categorie
     */
    public function removeCategorie(\LLPP\IndexBundle\Entity\CategorieArticoli $categorie)
    {
